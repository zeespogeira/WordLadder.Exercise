...
namespace WordLadder.Exercise.Implementations.Services
{
    public class UIService : IUIService
    {
        ...
        public void DisplaySuccessRunResult(WordLadderStrategyResponse response, string resultFileName)
        {
            ...
            Console.WriteLine($"Num. of Steps: {response.NumberOfSteps}");
            Console.WriteLine($"Steps: {response.Ladder.Aggregate((a, b)=> $"{a} -> {b}")}");
            Console.WriteLine($"File name: {resultFileName}");
        }

        public void FinishRun()
        {
            Console.WriteLine();
            Console.Write("Run finished! Press any key to end.");
            Console.Read();
        }
